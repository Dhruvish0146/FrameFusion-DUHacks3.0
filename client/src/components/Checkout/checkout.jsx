                ...
                <div className="grid grid-cols-5 gap-4">
                    ...
                    <div className="col-span-2">
                        <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                            ...
                            <div className="border-t border-gray-200 mb-4"></div> {/* Line in light gray color */}
                            ...
                            <div className="border-t border-dashed border-gray-200 mb-4"></div> {/* Dashed line */}
                            <div className="flex justify-between mb-4">
                                <div className="font-bold text-xl text-gray-700">Total Payable</div>
                                <div className="font-bold text-2xl text-gray-800">₹{art.price}</div>
                            </div>
                        </div>
